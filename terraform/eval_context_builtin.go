...
type BuiltinEvalContext struct {
	...
	// specific path, and can be safely used for evaluation. Path and
	// Evaluation methods will panic if this is not set.
	// This is a temporary safety mechanism while refactoring context usage,
	// and should be re-factored out later.
	pathSet bool
